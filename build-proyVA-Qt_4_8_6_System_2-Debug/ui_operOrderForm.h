...
public:
    ...
    void retranslateUi(QDialog *OperOrderForm)
    {
        ...
        operationComboBox1->insertItems(0, QStringList()
         ...
         << QApplication::translate("OperOrderForm", "Aperture", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("OperOrderForm", "Close", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("OperOrderForm", "Gradiente", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("OperOrderForm", "BlackHat", 0, QApplication::UnicodeUTF8)
        );
